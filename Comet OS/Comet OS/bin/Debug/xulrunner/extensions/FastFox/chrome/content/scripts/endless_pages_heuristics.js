//rel="next, Next, >>, More, Newer, >, <<, Older, ...
//page, entry, all
//Next: <a></a>
//"Page 1 >> Older" - twitter
//bigger font? lower score if have to share features?
//ENSURE SAME DOMAIN!!!!!!!!!!
//
/*
var doc = document;
var xpath = "//a[contains(translate(.,' ', ''), 'next') or contains(translate(following-sibling::node(),'ABCDEFGHIJKLMNOPQRSTUVWXYZ ', ''), 'common')]";
//"//[REMOVE THIS]*[contains(translate(.,' ', ''),'cat')]";
<a href="xpath_axes.asp">
<img width="100" height="20" border="0" alt="Next" src="/images/btn_next.gif"/>
</a>
